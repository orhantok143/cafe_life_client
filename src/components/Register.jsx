...
const Register = () => {
  const registerValidationSchema = Yup.object({
    name: Yup.string().required('İsim gerekli').min(2, 'En az 2 karakter'),
  ...
  return (
    <div className="max-w-md w-full mx-auto">
      <h2 className="text-3xl font-semibold text-white text-center mb-8">Kayıt Ol</h2>
      ...
      >
        <Form>
          <div className="mb-6 relative">
            ...
            />
            <ErrorMessage name="name" component="div" className="text-sm text-red-500 mt-1 ml-1" />
          </div>
